 ...
 * 
 */
public class GraphCohesionRDataStatisticCalculator
		extends
	 ...
	 */
	public GraphCohesionRDataStatisticCalculator(Repository repository,
	...
	protected GraphCohesionRDataStatistic calculateResultHelper(
		...
		REXP result = rEngine.eval("graph.cohesion(gr)");
