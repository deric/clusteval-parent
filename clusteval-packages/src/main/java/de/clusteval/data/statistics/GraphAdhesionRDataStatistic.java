...
public class GraphAdhesionRDataStatistic extends DoubleValueDataStatistic {
     ...
     *
     */
    public GraphAdhesionRDataStatistic(final IRepository repository,
     ...
     * @throws RegisterException
     */
    public GraphAdhesionRDataStatistic(
            final GraphAdhesionRDataStatistic other)
            throws RegisterException {
        super(other);
    }
