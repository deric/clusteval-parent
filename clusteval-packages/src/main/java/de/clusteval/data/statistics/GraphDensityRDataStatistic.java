...
public class GraphDensityRDataStatistic extends DoubleValueDataStatistic {
     ...
     *
     */
    public GraphDensityRDataStatistic(final IRepository repository,
     ...
     * @throws RegisterException
     */
    public GraphDensityRDataStatistic(final GraphDensityRDataStatistic other)
            throws RegisterException {
        super(other);
    }
