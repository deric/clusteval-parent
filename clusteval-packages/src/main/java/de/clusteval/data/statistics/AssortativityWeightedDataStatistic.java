...
public class AssortativityWeightedDataStatistic
        extends
     ...
     *
     */
    public AssortativityWeightedDataStatistic(final IRepository repository,
     ...
     * @throws RegisterException
     */
    public AssortativityWeightedDataStatistic(
            final AssortativityWeightedDataStatistic other)
            throws RegisterException {
        super(other);
    }
