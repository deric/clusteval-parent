 ...
 *
 */
public class IntraInterOverlapDataStatistic extends DoubleValueDataStatistic {
     ...
     *
     */
    public IntraInterOverlapDataStatistic(final IRepository repository,
            final boolean register, final long changeDate, final File absPath)
            throws RegisterException {
        this(repository, register, changeDate, absPath, 0.0);
    }
     ...
     * @throws RegisterException
     */
    public IntraInterOverlapDataStatistic(final IntraInterOverlapDataStatistic other)
            throws RegisterException {
        super(other);
    }
