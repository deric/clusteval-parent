...
public class GraphDiversityAverageRDataStatistic
	 ...
	 * 
	 */
	public GraphDiversityAverageRDataStatistic(final Repository repository,
	 ...
	 * @throws RegisterException
	 */
	public GraphDiversityAverageRDataStatistic(
			final GraphDiversityAverageRDataStatistic other)
			throws RegisterException {
		super(other);
	}
