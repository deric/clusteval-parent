...
public class GraphDiversityAverageRDataStatistic
        extends
    ...
    public String getName() {
        return "Graph Diversity Average";
    }
     ...
     *
     */
    public GraphDiversityAverageRDataStatistic(final IRepository repository,
     ...
     * @throws RegisterException
     */
    public GraphDiversityAverageRDataStatistic(final GraphDiversityAverageRDataStatistic other)
            throws RegisterException {
        super(other);
    }
