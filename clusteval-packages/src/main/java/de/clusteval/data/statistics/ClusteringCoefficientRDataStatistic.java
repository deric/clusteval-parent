...
public class ClusteringCoefficientRDataStatistic extends DoubleValueDataStatistic {
     ...
     *
     */
    public ClusteringCoefficientRDataStatistic(final IRepository repository,
     ...
     * @throws RegisterException
     */
    public ClusteringCoefficientRDataStatistic(final ClusteringCoefficientRDataStatistic other)
            throws RegisterException {
        super(other);
    }
