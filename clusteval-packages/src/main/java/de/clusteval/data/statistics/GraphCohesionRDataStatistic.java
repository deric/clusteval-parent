...
public class GraphCohesionRDataStatistic extends DoubleValueDataStatistic {
     ...
     *
     */
    public GraphCohesionRDataStatistic(final IRepository repository,
     ...
     * @throws RegisterException
     */
    public GraphCohesionRDataStatistic(
            final GraphCohesionRDataStatistic other)
            throws RegisterException {
        super(other);
    }
