...
public class GraphAdhesionRDataStatisticCalculator
     ...
     */
    public GraphAdhesionRDataStatisticCalculator(IRepository repository,
     ...
     */
    @Override
    protected GraphAdhesionRDataStatistic calculateResultHelper(final IRengine rEngine)
        ...
        RExpr result = rEngine.eval("graph.adhesion(gr)");
