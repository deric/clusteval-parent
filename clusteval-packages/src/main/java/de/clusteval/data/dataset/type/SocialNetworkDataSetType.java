...
public class SocialNetworkDataSetType extends AbsDataType {

    public SocialNetworkDataSetType() {
        super();
    }
     ...
     */
    public SocialNetworkDataSetType(final SocialNetworkDataSetType other)
            throws RegisterException {
        super(other);
    }
