...
public class TwonormDataSetGenerator extends DataSetGenerator {
     ...
     */
    public TwonormDataSetGenerator(IRepository repository, boolean register, long changeDate, File absPath)
            throws RegisterException {
     ...
     * @throws RegisterException
     */
    public TwonormDataSetGenerator(DataSetGenerator other) throws RegisterException {
        super(other);
    }
    ...
    public void generateDataSet() throws DataSetGenerationException, InterruptedException {
        try {
            ...
            rEngine.eval("result <- mlbench.twonorm(n=" + this.numberOfPoints + ",d=" + this.numberDimensions + ");");
