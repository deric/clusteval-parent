...
public class RingnormDataSetGenerator extends DataSetGenerator {
	 ...
	 */
	public RingnormDataSetGenerator(Repository repository, boolean register, long changeDate, File absPath)
			throws RegisterException {
	...
	protected void generateDataSet() throws DataSetGenerationException, InterruptedException {
		try {
			...
			rEngine.eval("result <- mlbench.ringnorm(n=" + this.numberOfPoints + ",d=" + this.numberDimensions + ");");
