...
public class CircleDataSetGenerator extends DataSetGenerator {
     ...
     */
    public CircleDataSetGenerator(DataSetGenerator other) throws RegisterException {
        super(other);
    }
    ...
    public void generateDataSet() throws DataSetGenerationException, InterruptedException {
        try {
            ...
            rEngine.eval("result <- mlbench.circle(n=" + this.numberOfPoints + ",d=" + this.numberDimensions + ");");
