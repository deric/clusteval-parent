 ...
 *
 */
public class DivisiveParameterOptimizationMethod extends ParameterOptimizationMethod {

    protected int[] iterationPerParameter;

    protected Map<IProgramParameter<?>, Integer> currentPos;
    protected Map<IProgramParameter<?>, String[]> parameterValues;
    ...
    public DivisiveParameterOptimizationMethod(final IRepository repo,
    ...
    protected void initParameterValues() throws ParameterOptimizationException,
        ...
        for (int p = 0; p < this.params.size(); p++) {
            IProgramParameter<?> param = this.params.get(p);
    ...
    public boolean hasNext() {
        ...
        boolean carry = true;
        while (carry) {
            IProgramParameter<?> param = this.params.get(currentParamPos);
