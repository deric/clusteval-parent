 ...
 *
 */
@RLibraryRequirement(requiredRLibraries = {"lars"})
public class LinearModelLassoRunDataStatistic extends RunDataStatistic {
     ...
     * @throws RegisterException
     */
    public LinearModelLassoRunDataStatistic(
            final LinearModelLassoRunDataStatistic other)
            throws RegisterException {
        super(other);
