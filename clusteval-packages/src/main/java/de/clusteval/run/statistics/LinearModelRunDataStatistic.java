 ...
 *
 */
public class LinearModelRunDataStatistic extends RunDataStatistic {
     ...
     *
     */
    public LinearModelRunDataStatistic(Repository repo, boolean register,
     ...
     * @throws RegisterException
     */
    public LinearModelRunDataStatistic(IRepository repo, boolean register,
     ...
     * @throws RegisterException
     */
    public LinearModelRunDataStatistic(final LinearModelRunDataStatistic other)
            throws RegisterException {
        super(other);
        this.dataStatistics = new ArrayList<>(other.dataStatistics);
