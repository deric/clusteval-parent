 ...
 *
 */
public final class RepositoryObjectTest extends AbstractClustEvalTest {
    ...
    public void testAddListener() throws RegisterException {
         ...
         */
        assertFalse(repositoryObject.addListener(repositoryObject));

        RepositoryObject other = new StubRepositoryObject(this.getRepository(),
                false, System.currentTimeMillis(), new File("test2"));

        assertTrue(this.repositoryObject.addListener(other));

        /*
         * Already in there
         */
        assertFalse(this.repositoryObject.addListener(other));

        assertTrue(this.repositoryObject.removeListener(other));
        /*
