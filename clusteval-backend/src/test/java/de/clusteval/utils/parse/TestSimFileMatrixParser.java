...
public class TestSimFileMatrixParser {
    ...
    public void testMatrixParsing() {
        try {
            ...
            System.out.println("expected: " + expectedMatrix);
    ...
    public void testOutput() {
        try {
            ...
            FileAssert.assertEquals(
                    new File("testCaseRepository/data/datasets/rowSimTest/rowSimTestFile.sim.strip"),
                    new File("testCaseRepository/data/datasets/rowSimTest/rowSimTestFile.sim.strip.out"));
