 ...
 * <li>At the end use {@link #getResult()} to get the results of the
 * iterations</li>
 * </ul>
 *
...
public abstract class ParameterOptimizationMethod extends RepositoryObject implements IParameterOptimizationMethod {
    ...
    public static List<ParameterOptimizationMethod> cloneOptimizationMethods(
        ...
        List<ParameterOptimizationMethod> result = new ArrayList<>();
     ...
     * several quality measures are assessed. One of these quality measures is
     * used, to rate the clusterings and to decide, which clusterings performed
