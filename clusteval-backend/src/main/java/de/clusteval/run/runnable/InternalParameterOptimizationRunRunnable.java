 ...
 *
 */
public class InternalParameterOptimizationRunRunnable extends ExecutionRunRunnable {
    ...
    protected String getInvocationFormat() {
        return programConfig.getInvocationFormatParameterOptimization(!dataConfig.hasGoldStandardConfig());
    }
     ...
     */
    @Override
    protected void beforeRun() throws IllegalArgumentException, IOException,
