 ...
 *
 *   * :java:ref:`RunStatistic(IRepository, boolean, long, File)` : The constructor for your run statistic. This constructor has to be implemented and public.
 ...
 *
 *   * :java:ref:`RunStatisticCalculator(IRepository, long, File, DataConfig)` : The constructor for your run statistic calculator. This constructor has to be implemented and public.
...
public abstract class RunStatistic extends Statistic {
     ...
     */
    public static RunStatistic parseFromString(final IRepository repository,
        ...
        try {
            RunStatistic statistic = c.getConstructor(IRepository.class,
