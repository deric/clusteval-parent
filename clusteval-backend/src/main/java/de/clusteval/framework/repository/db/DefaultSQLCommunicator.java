...
public class DefaultSQLCommunicator extends SQLCommunicator implements Database {
    ...
    @Override
    public int getParameterOptimizationMethodId(final String name)
            throws SQLException {
    ...
    public int register(ParameterOptimizationResult object) {
        ...
        try {
            ...
            try {
                ...
                repository_id = getRepositoryId(ctrl.getRepositoryForPath(object.getAbsolutePath())
                        .getBasePath());
            ...
            for (int i = 0; i < iterationIds.length; i++) {
                ...
                for (ClusteringEvaluation measure : pair.getSecond()
                        .keySet()) {
    ...
    public boolean unregisterClusteringQualityMeasureClass(
            Class<? extends ClusteringEvaluation> object) {
        try {
