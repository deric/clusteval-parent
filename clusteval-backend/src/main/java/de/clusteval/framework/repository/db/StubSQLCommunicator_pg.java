...
public class StubSQLCommunicator_pg extends SQLCommunicator {
     ...
     */
    @Override
    public int getDataSetFormatId(String dataSetFormatClassSimpleName) throws SQLException {
        return 0;
    }
     ...
     */
    @Override
    public int getRunResultId(String uniqueRunIdentifier)
            throws SQLException {
        return 0;
    }
     ...
     */
    @Override
    protected int register(ParameterOptimizationRun run, final boolean updateOnly) {
        return -1;
    }
     ...
     */
    @Override
    protected int getClusterObjectId(int clusterId, String name) throws SQLException {
        return 0;
    }
     ...
     */
    @Override
    public boolean unregisterClusteringQualityMeasureClass(Class<? extends ClusteringEvaluation> object) {
        return false;
    }
