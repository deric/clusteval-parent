...
public class DefaultSQLCommunicator_pg extends SQLCommunicator {
     ...
     */
    public DefaultSQLCommunicator_pg(IRepository repository,
    ...
    public int getRunId(final IRun run) throws SQLException {
        return this.select(this.getTableRuns(), "id", new String[]{"repository_id", "abs_path"},
                new String[]{
    ...
    @Override
    public int getRunResultFormatId(final String runResultFormatSimpleName)
            throws SQLException {
    ...
    protected int register(Program object, final boolean updateOnly) {
        try {
            ...
            int id = insert(
                    ...
                    new String[]{"" + this.updateRepositoryId(),
                        "" + object.getAbsolutePath(), object.getName()});
    ...
    protected boolean registerDataSetTypeClass(
        ...
        try {
            IDataSetType type = object.getConstructor(IRepository.class,
    ...
    public int register(ClusteringRunResult object) {
        ...
        try {
            ...
            for (ClusteringEvaluation measure : qualities.keySet()) {
